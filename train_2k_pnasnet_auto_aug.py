...
opt.TRAIN.BATCH_SIZE = 7 * torch.cuda.device_count()
opt.TRAIN.LOSS = 'BCE'
...
opt.TRAIN.PATIENCE = 2
opt.TRAIN.LR_REDUCE_FACTOR = 0.1
...
if __name__ == '__main__':
    ...
    params = {'affine': 'none',
              'aug_global_prob': 0.6349067996869184,
              'blur': 0.21553364299024902,
              'color': 0.08327738552991053,
              'distortion': 0.21858046296702952,
              'dropout': 0.5,
              'noise': 0.1030783616676692,
              'rotate90': 0,
              'vflip': 0}
